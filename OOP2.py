    ...
    def check_salary(self):
        ...
        for day in range(diff):
            if (month_start + timedelta(day)).weekday() not in weekend:
                day_count += 1
        return '{} earned {} USD for {} days.'.format(self.name, day_count * self.salary, day_count)
...
class Programmer(Employee):
    ...
    def work(self):
        ...
        return programmer_work + " and start cod."
...
person1 = Programmer("Denys", 600, ["Python", "Js", "Css", "Html"], 5)
person2 = Programmer("Igor", 320, ["Swift", "Js", "Java"], 8)
person3 = Recruiter("Khu-lo", 150, 15)
person4 = Recruiter("James", 400, 20)
